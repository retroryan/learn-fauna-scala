...
object Main extends Logging {
  ...
  private def originalCustomerTests(implicit client: FaunaClient) = {
    ...
    val cust1 = Customer(1, 100, OldWorkAddress("pc", "ut"))
    val cust2 = Customer(2, 100, WorkAddress("ny", "ny"))
    val cust3 = Customer(3, 100, HomeAddress("sf", "ca", "fido"))
    val cust4 = Customer(4, 100, EmptyAddress)
